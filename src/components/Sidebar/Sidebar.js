    ...
    <div className={isScreenSmall ? "menu-scroll no-padding text-center" : "menu-scroll no-padding"} >
      ...
      <div className={isScreenSmall ? 'text-center' : ''} style={{ fontSize: '16px', marginTop: '20px' }}>
        ...
        <ul className='list-style responsive-text'>
          ...
          <br/>
          <li className={isScreenSmall ? 'd-flex align-items-center justify-content-center' : isMenuExpanded ? '' : 'd-flex align-items-center justify-content-center'}><i className='fas fa-graduation-cap'></i> <span className='text-center'><Link to={'/component3'}>Định Nghĩa Tiêu Chuẩn</Link></span></li>
